...
4. ONLY quote from the New International Version (NIV) of the Bible. Do NOT use KJV, NLT, or any other version.
...
2. ONE Bible verse from the NIV (quoted exactly, with book, chapter and verse).
...
const SYNTHESIS_PROMPT = `Based on the conversation below, generate a full biblical vision document that is SPECIFIC to this exact conversation. 

CRITICAL: This vision must reflect the UNIQUE details, names, projects, concepts, and ideas from THIS specific conversation. Do NOT generate a generic vision. If the person mentioned a specific project name, technology, organization, concept, or calling — it MUST appear in the vision document. The vision title, mandate, and summary must clearly reflect what was discussed.
...

{
  ...
  "spiritual_foundation": {
    "anchor_scriptures": [
      "Book Chapter:Verse - \"Exact verse text from NIV\" - Simple explanation of how this verse applies.",
      "Book Chapter:Verse - \"Exact verse text from NIV\" - Simple explanation of how this verse applies.",
      "Book Chapter:Verse - \"Exact verse text from NIV\" - Simple explanation of how this verse applies.",
      "Book Chapter:Verse - \"Exact verse text from NIV\" - Simple explanation of how this verse applies.",
      "Book Chapter:Verse - \"Exact verse text from NIV\" - Simple explanation of how this verse applies.",
...
- Use the New International Version (NIV) for ALL Bible verses
- Return ONLY valid JSON, no markdown, no code blocks, no extra text
- Fill in ALL fields based on the conversation
- CRITICAL: Use SPECIFIC names, projects, organizations, technologies, and concepts mentioned in the conversation — do NOT make them generic
...
- CRITICAL: anchor_scriptures MUST follow this EXACT format: "Book Chapter:Verse - Exact quote of the verse from NIV - Explanation of how it applies." Example: "John 3:16 - For God so loved the world that he gave his one and only Son - This shows God's unconditional love for all people."`;
  ...
  try {
      ...
      if (jsonStart === -1 || jsonEnd === -1) {
        throw new Error("Failed to generate vision document. Please try again.");
      }
