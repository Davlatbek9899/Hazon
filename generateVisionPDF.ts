...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .scripture-text { font-family: 'Playfair Display', serif; font-size: 11.5px; font-style: italic; color: #333; line-height: 1.6; margin-bottom: 3px; }
  .scripture-ref { font-family: 'Lato', sans-serif; font-size: 8px; color: #aaa; letter-spacing: 0.5px; }

  .value-card { background: #f0ede8; padding: 11px 13px; border-radius: 2px; margin-bottom: 9px; }
  .value-title { font-family: 'Lato', sans-serif; font-size: 9px; font-weight: 700; color: #111; letter-spacing: 1.2px; text-transform: uppercase; margin-bottom: 3px; }
  .value-desc { font-family: 'Playfair Display', serif; font-size: 11px; color: #555; line-height: 1.5; }

  .pillar-item { margin-bottom: 13px; padding-bottom: 13px; border-bottom: 0.5px solid #e8e4de; }
  .pillar-title { font-family: 'Lato', sans-serif; font-size: 9px; font-weight: 700; color: #111; letter-spacing: 0.8px; text-transform: uppercase; margin-bottom: 3px; }
  .pillar-desc { font-family: 'Playfair Display', serif; font-size: 11px; color: #555; line-height: 1.5; }

  .model-card { background: #f0ede8; padding: 13px 15px; border-radius: 2px; }
  .model-name { font-family: 'Playfair Display', serif; font-size: 12px; font-weight: 400; color: #111; margin-bottom: 4px; }
  .model-attr { font-family: 'Playfair Display', serif; font-size: 10.5px; font-style: italic; color: #555; line-height: 1.5; }

  .bullet-item { display: flex; gap: 9px; margin-bottom: 8px; }
  .bullet-dot { color: #bbb; font-size: 13px; line-height: 1.3; min-width: 9px; }
  .bullet-text { font-family: 'Playfair Display', serif; font-size: 11.5px; color: #333; line-height: 1.6; }

  .numbered-item { display: flex; gap: 13px; margin-bottom: 10px; align-items: flex-start; }
  .numbered-num { font-family: 'Lato', sans-serif; font-size: 10px; font-weight: 700; color: #bbb; min-width: 15px; padding-top: 2px; }
  .numbered-text { font-family: 'Playfair Display', serif; font-size: 11.5px; color: #333; line-height: 1.6; }

  .context-item { margin-bottom: 13px; }
  .context-label { font-family: 'Lato', sans-serif; font-size: 7.5px; letter-spacing: 2px; color: #888; margin-bottom: 3px; text-transform: uppercase; }
  .context-text { font-family: 'Playfair Display', serif; font-size: 11.5px; color: #333; line-height: 1.6; }
  .resource-box { background: #f0ede8; padding: 13px 15px; border-radius: 2px; margin-top: 14px; }

  .impact-label { font-family: 'Lato', sans-serif; font-size: 7.5px; letter-spacing: 2px; color: #888; text-transform: uppercase; margin-bottom: 5px; }
  .impact-text { font-family: 'Playfair Display', serif; font-size: 11.5px; color: #333; line-height: 1.6; }

  /* Declarations — dark page */
  .declarations-label { font-family: 'Lato', sans-serif; font-size: 8px; letter-spacing: 4px; color: #555; text-transform: uppercase; text-align: center; margin-bottom: 44px; }
  .declaration-item { text-align: center; margin-bottom: 26px; }
  .declaration-text { font-family: 'Playfair Display', serif; font-size: 14px; font-style: italic; font-weight: 400; color: #fff; line-height: 1.8; }

  /* Prayer */
  .prayer-text { font-family: 'Playfair Display', serif; font-size: 12.5px; font-style: italic; color: #444; line-height: 1.9; }
  .reflection-item { font-family: 'Playfair Display', serif; font-size: 11.5px; font-style: italic; color: #444; line-height: 1.65; padding-left: 11px; border-left: 1.5px solid #c8c4be; margin-bottom: 13px; }
  ...
  .footer-text { font-family: 'Lato', sans-serif; font-size: 7px; letter-spacing: 2px; color: #bbb; text-transform: uppercase; }
  ...
  <div style="flex:1; display:flex; flex-direction:column; justify-content:center; padding: 20px 0;">
    ...
    ${nextSteps.map((item: string, idx: number) => `
      <div class="numbered-item" style="margin-bottom:18px;">
        <span class="numbered-num" style="font-size:13px; color:#111; min-width:24px;">${idx + 1}</span>
        <span class="numbered-text" style="font-size:13px;">${item}</span>
      </div>
    `).join('')}
  </div>
